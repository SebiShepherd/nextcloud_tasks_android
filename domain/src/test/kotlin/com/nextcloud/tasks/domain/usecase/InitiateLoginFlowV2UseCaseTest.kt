...
class InitiateLoginFlowV2UseCaseTest {
    ...
    @Test
    fun `invoke calls repository initiateLoginFlowV2 with serverUrl`() = runTest {
        val serverUrl = "https://cloud.example.com"
        val initiation = LoginFlowV2Initiation(
    ...
    @Test
    fun `invoke returns initiation from repository`() = runTest {
