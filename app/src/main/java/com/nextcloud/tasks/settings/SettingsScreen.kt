...
private fun getLanguageDisplayName(language: Language): String =
    when (language) {
        ...
        Language.ITALIAN -> stringResource(R.string.language_italian)
        Language.DUTCH -> stringResource(R.string.language_dutch)
        Language.PORTUGUESE_BR -> stringResource(R.string.language_portuguese_br)
        Language.RUSSIAN -> stringResource(R.string.language_russian)
        Language.POLISH -> stringResource(R.string.language_polish)
