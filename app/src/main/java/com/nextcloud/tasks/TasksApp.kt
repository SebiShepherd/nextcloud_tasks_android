...
class TasksApp :
    ...
    override fun onCreate() {
        ...
        // Track app foreground state so the certificate trust prompt is only shown while the app
        // is interactive; background syncs reject unknown certificates silently. Must run on the
        // main thread.
