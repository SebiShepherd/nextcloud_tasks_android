...
- `android.permission.INTERNET`
  ...
  Used to communicate with your Nextcloud instance and synchronize tasks via CalDAV.

- `android.permission.ACCESS_NETWORK_STATE`

  Used to provide offline support and detect network connectivity changes.

- `android.permission.GET_ACCOUNTS`

  Used to read available Nextcloud accounts on the device for multi-account support.
